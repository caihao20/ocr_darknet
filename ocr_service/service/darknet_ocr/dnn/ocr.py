...
from ocr_service.service.darknet_ocr.config import ocrPath,GPU
from dnn.darknet import  predict_image,array_to_image
from ocr_service.settings import PARAM
# def read_characters():
...
charactersPred = PARAM['charactersPred']
ocrNet = PARAM['ocrNet'] 
